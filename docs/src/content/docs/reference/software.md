---
title: Software
description: Software reference for dashboard telemetry streaming and UART payload contracts.
sidebar:
    order: 5
---
...
This document covers software-facing interfaces currently used in this workspace:
